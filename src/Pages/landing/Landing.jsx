    ...
    <div className="min-h-screen">
      ...
      <nav className="flex items-center justify-between p-4 ">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="bg-white text-teal-600 px-4 py-2 rounded border border-teal-600 hover:bg-gray-100 transition-colors">
            Login
          </button>
        </div>
      </nav>
      <section className="relative overflow-hidden">
        ...
        >
          ...
          <g transform="scale(1, 0.8)">
            <path
              d="M0 18.4479C51.6701 33.7342 218.605 83.0874 310.021 110.166C401.437 137.245 222.579 -5.13675 310.021 18.4479C397.463 42.0325 1042.84 -18.6806 1138.23 -2.08398C1233.62 14.5126 1235.13 -1.64273 1334.5 18.4479C1433.87 38.5385 1430.87 339.461 1430.87 372.217V1047H0V18.4479Z"
              fill="url(#paint0_linear_192_65)"
            />
          </g>
          <g transform="scale(1, 0.7)">
            <path
              d="M0 136.324C55.6448 155.543 210.655 216.694 333.869 251.638C457.082 286.583 612.093 314.538 739.281 345.989C866.469 377.439 981.733 412.383 1097 440.339C1212.26 468.295 1375.22 501.494 1430.87 513.725V1047H0V136.324Z"
              fill="url(#paint1_linear_192_65)"
            />
          </g>
          <g transform="scale(1, 0.7)">
            <path
              d="M0 254.2C43.7209 268.834 186.807 316.229 262.325 342.003C337.843 367.776 381.564 386.562 453.108 408.842C524.651 431.121 604.143 460.389 691.585 475.68C779.027 490.972 898.266 478.311 977.758 500.591C1057.25 522.871 1093.02 583.584 1168.54 609.358C1244.06 635.132 1387.14 647.587 1430.87 655.233V1047H0V254.2Z"
              fill="url(#paint2_linear_192_65)"
            />
          </g>
          <g transform="scale(1, 0.799999)">
            <path
              d="M0 372.076C25.8351 377.429 99.3656 389.994 155.01 404.195C210.655 418.395 274.249 432.595 333.869 457.278C393.488 481.96 445.158 527.607 512.727 552.289C580.296 576.972 679.661 587.678 739.281 605.372C798.9 623.067 810.824 640.761 870.443 658.456C930.063 676.15 1029.43 700.832 1097 711.539C1164.57 722.245 1220.21 708.493 1275.85 722.694C1331.5 736.894 1405.03 784.4 1430.87 796.741V1047H0V372.076Z"
              fill="url(#paint3_linear_192_65)"
            />
          </g>
          <path
            d="M0 424.439C38.0428 438.607 156.146 491.592 228.257 509.445C300.368 527.299 364.53 510.212 432.667 531.56C500.803 552.907 568.939 616.183 637.076 637.53C705.212 658.878 773.349 645.285 841.485 659.644C909.622 674.004 985.707 702.339 1045.89 723.687C1106.08 745.034 1138.45 762.888 1202.61 787.729C1266.77 812.571 1392.82 858.568 1430.87 872.736V1047H0V424.439Z"
            fill="url(#paint4_linear_192_65)"
          />
          <defs>
            <linearGradient
              id="paint0_linear_192_65"
              x1="715.438"
              y1="-5"
              x2="715.438"
              y2="1047"
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg mb-6">
                  Get ready to bring your wildest ideas to life! Grab your
                  crayons, markers, or pencils and let your creativity soar.
                  Every drawing tells a story—let yours begin!
                </p>
      ...
      <section className="py-12 px-4 bg-gray-100">
        ...
        <div className="max-w-xl mx-auto relative">
          <AnimatePresence mode="wait" initial={false}>
            <TestimonialCard
              key={currentTestimonial} // Ensures component re-renders for each testimonial
              {...testimonials[currentTestimonial]}
            />
          </AnimatePresence>
          <button
            onClick={handlePrevious}
            className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-full bg-white rounded-full p-2 shadow-md z-10"
          ...
          <button
            onClick={handleNext}
            className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-full bg-white rounded-full p-2 shadow-md z-10"
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold mb-2">
              Card<span className="text-sky-400">Board</span>
            </h2>
